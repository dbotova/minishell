...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/11/18 17:59:27 by dbotova           #+#    #+#             */
/*   Updated: 2017/01/07 17:53:34 by dbotova          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int			ft_chex_print(va_list ap, union u_types tp, t_flags *flags)
{
	int		size;
	char	*prefix;
	char	*width;
	...
	flags->target = ft_strupcase(flags->target);
	if (flags->is_hash)
	{
